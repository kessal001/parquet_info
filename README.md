...
```powershell
parquet-info examples\demo_inventory.parquet --browse
```
...
| `--columns` | Comma-separated columns to preview, profile, or search |
...
| `scripts/generate_readme_assets.py` | Regenerates screenshot SVGs from real CLI output |
...
>>>>>>> a48b722288125be1eaba7c11a9dba74bc811a8ed
